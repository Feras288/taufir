...
function ContactFormContent() {
    ...
    // Try to find the product from the URL, or fallback to general
    const selectedProduct = products.find(p => p.id === productId) || {
        id: productId || '',
        nameEn: 'General Inquiry',
        nameAr: 'استفسار عام',
        ref: productId ? 'Custom' : 'N/A'
    };
    ...
    const handleSubmit = async () => {
        ...
        try {
            ...
            if (res.ok) {
                ...
                // Reset success message after 5 seconds to avoid permanent DOM state
                ...
                <div style={{ display: 'grid', gridTemplateColumns: '1.2fr 1fr', gap: 48 }}>
                    ...
                    <div>
                        ...
                        <div style={{
                            ...
                            {/* Status Messages - Wrapped in stable div to prevent DOM mismatch */}
                            <div style={{ minHeight: status !== 'idle' ? 'auto' : 0 }}>
                                {status === 'success' && (
                                    <div key="success-msg" style={{
                            ...
                            >
                                <span key={status === 'loading' ? 'loading' : 'idle'}>
